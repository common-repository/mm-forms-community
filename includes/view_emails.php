...
<form method="post" name="frm_emails" id="frm_emails" action="<?php echo $base_url.'?page=' . MM_FORMS_FILE . '&action=deleteselection&form_id=' . $get_id ; ?>">
		...
		foreach($obj_actions->emails as $mail)
		{
			...
			?>
				<tr class="<?php echo $class ?>">
					...
					<?php } ?>
					<th style="font-weight:normal;" scope="col"><a href="<?php echo $base_url . '?page=' . $page . '&action=viewDetail&t=edit&id=' . $mail->id . '&form_id=' . $get_id ?>"><img src="<?php echo plugins_url( 'images/pencil.png' , dirname(__FILE__) ); ?>"/></a></th>
					<th style="font-weight:normal;" scope="col"><a href="<?php echo $base_url . '?page=' . $page . '&action=viewDetail&id=' . $mail->id . '&form_id=' . $get_id ?>"><img src="<?php echo plugins_url('images/view.png', dirname(__FILE__) ); ?>" /></a></th>
<!--					<th style="font-weight:normal;text-align:center;" scope="col">
						<a href="<?php echo $base_url . '?page=' . $page . '&action=deletemail&form_id='.$mail->fk_form_id.'&id=' . $mail->id ?>">
							<img onclick="return confirm('Are you sure you want to delete this record')" src="<?php echo plugins_url('images/delete.png', dirname(__FILE__) ); ?>" />
						</a>
					</th>	-->				
				</tr>
			<?php
