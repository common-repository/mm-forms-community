...
<h3>Post and page tags</h3>
	<?php if (! $unsaved) : ?>
		...
		<p class="tagcode" style="margin-top:0px;">
		<?php _e('To display the submissions of this form in a post or page copy paste the following into your post or page.', 'mmf'); ?><br />
		<input type="text" id="form-anchor-data" onfocus="this.select();" readonly="readonly" size="30" /><br />
		</p>
	<?php endif; ?>
