<?php
/* 
 * This is RSS Feed class. The MM Form is using this class. 
 * This class will be used to generate RSS feed for for for submission.
 */
class RSSFeed {
// VARIABLES
    // channel vars
...
// FUNCTIONS
    ...
    function SetItem($url, $title, $description) {
       ...
       // $this->items[$this->nritems]['fields']=$fields;
    ...
    function Output() {
        ...
        for($k=0; $k<$this->nritems; $k++) {
            ...
            /*
            foreach($this->items[$k]['fields'] as $key=>$value){
